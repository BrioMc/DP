...
/**
 * Generador de n�meros aleatorios - proyecto12_13 Implementacion de la clase
 * que permite generar n�meros aleatorios
 * 
 * @version 1.0
...
public class GenAleatorios {
	...
	/**
	 * Constante con la semilla para inicializar la generaci�n de n�meros
	...
	/**
	 * Instancia de la propia clase (s�lo habr� una en el sistema). Ver PATR�N
	 * DE DISE�O SINGLETON
	 */
	...
	private GenAleatorios() {
		...
		// Inicializaci�n del atributo que cuenta cu�ntos n�meros aleatorios se
		// han generado
		numGenerados = 0;
	}

	/**
	 * Metodo generarNumero. Genera un n�mero aleatorio entre 0 y
	 * (limiteRango-1)
	 * 
	 * @param limiteRango
	 *            El l�mite del rango en el que generar los aleatorios
